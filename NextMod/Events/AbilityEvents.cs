...
/// </summary>
public class AbilityEvent : MiraEvent
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="AbilityEvent" /> class.
    /// </summary>
    ...
    public AbilityEvent(AbilityType ability, PlayerControl player, MonoBehaviour? target = null,
