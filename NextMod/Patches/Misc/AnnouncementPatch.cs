...
#pragma warning disable S1075 // URIs should not be hardcoded
    private static string ModNewsURL =
        "https://raw.githubusercontent.com/TownofReworked/NEXTaunchpad/master/NEXT/Resources/Announcements/modNews-";
#pragma warning restore S1075 // URIs should not be hardcoded
    ...
    public static IEnumerator FetchNews()
    {
        ...
        {
            downloaded = false;
            Logger<NEXTPlugin>.Error($"Couldn't fetch mod news from github: {request.error}");
    ...
    private static void LoadModNewsFromResources()
    {
        ...
        using var resourceStream =
            assembly.GetManifestResourceStream("NEXT.Resources.Announcements.modNews-" + filename)
            ?? throw new InvalidOperationException(
                $"Resource not found: NEXT.Resources.Announcements.modNews-{filename}");
    ...
    public static class ModNewsHistory
    {
        ...
        public static void SetModAnnouncements_Prefix(ref Il2CppReferenceArray<Announcement> aRange)
        {
            ...
            {
                Logger<NEXTPlugin>.Error($"No mod news were found.");
                return;
            }
